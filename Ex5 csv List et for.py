...
with open(ficher_a_lire,"r",encoding="utf-8") as fichier_lu:
    ...
    for ligne in lecteur:
        if ligne[2] == 'TI':
            stage_importe.append(ligne)

with open("Ex5 Stages TI.csv","w",encoding="utf-8") as fichier_ecrit:
    ecriveur = csv.writer(fichier_ecrit,delimiter='|',lineterminator='\n')
    for stage in stage_importe:
        ecriveur.writerow(stage)
